 ...
 * + per-article sections. Server component; scoring is done by the evaluate
 * cron — this only renders the committed verdicts.
 */
...
export function ScoredBoard({ catalysts }: { catalysts: ExternalCatalyst[] }) {
